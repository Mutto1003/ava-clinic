        ...
        <div class="p-6 space-y-7">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                <div>
                    ...
                    <p
                        v-if="form.email && form.email.includes('@avaclinic')"
                        class="text-[10px] text-emerald-600 font-bold mt-1 flex items-center gap-1"
                    >
                        <UIcon
            ...
            <div>
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    >
                        <UIcon
                            v-if="form.branches.includes(branch)"
                            name="i-lucide-check"
                            class="w-3 h-3"
                        />
                        {{ branch }}
